  ...
  return (
    <section id="section-comparison" className="section-anchor proposal-section">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="overflow-hidden rounded-2xl border border-[rgba(51,102,204,0.15)] bg-[rgba(10,10,15,0.6)]">
          {/* Header */}
          <div className="grid grid-cols-3 border-b border-[rgba(51,102,204,0.1)] bg-[rgba(51,102,204,0.05)] px-6 py-3">
          ...
          {rows.map((row, i) => (
            <div
              key={row.capability}
              className="grid grid-cols-3 items-center border-b border-[rgba(51,102,204,0.06)] px-6 py-3 last:border-0 hover:bg-[rgba(51,102,204,0.03)] transition-colors"
            >
